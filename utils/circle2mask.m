function [ m ] = circle2mask( radius, center, w, h )
%CIRCLE2MASK Creates a circular mask with radius |radius| and center
%|center| in w-by-h matrix.  

[x,y] = circlepoints(radius);
m = poly2mask(radius+x+center(1),radius+y+center(2),w,h);
